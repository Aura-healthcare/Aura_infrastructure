...
from energy_injector_methods import (create_and_write_energy_for_user, get_user_list)
...
dag = DAG('energy_data_injector', default_args=default_args, catchup=False, schedule_interval="@daily")
